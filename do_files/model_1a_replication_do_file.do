** model_1a_replication_do_file.do
* Description: Cuervo-Cazurra and Genc (2008) replication - model 1a
...
xttobit prop_emnes gni_per_capita perc_roads_paved total_phones_per_1000 geographic_proximity colonial_link, ll(0) ul(100) re
...
tobit prop_emnes gni_per_capita perc_roads_paved total_phones_per_1000 geographic_proximity colonial_link, ll(0) ul(100)
...
summarize prop_emnes gni_per_capita perc_roads_paved total_phones_per_1000 geographic_proximity colonial_link

pwcorr prop_emnes gni_per_capita perc_roads_paved total_phones_per_1000 geographic_proximity colonial_link, star(0.05)
