...
putexcel set "../results/random_effects_model_3b.xlsx", replace
putexcel A1 = matrix(b), names
putexcel set "../results/random_effects_model_3b.xlsx", modify
...
putexcel set "../results/pooled_tobit_model_3b.xlsx", replace
putexcel A1 = matrix(b), names
putexcel set "../results/pooled_tobit_model_3b.xlsx", modify
putexcel A1 = matrix(V)
...
export excel using "../results/summary_statistics_3b.xlsx", sheet("Summary Statistics") firstrow(variables) replace
...
putexcel set "../results/correlation_matrix_3b.xlsx", replace
